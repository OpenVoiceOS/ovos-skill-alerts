...
# passed in 144s, so the skip is lifted. The test extra in setup.py now floors
# ovoscope at the version this was measured on, because an older harness makes
# this whole module ERROR at fixture setup rather than fail one row.
