...
class TestAdapt2_Createalarm(_IntentRoutingMixin, TestCase):
    ...
    @unittest.expectedFailure  # TODO(https://github.com/OpenVoiceOS/ovos-skill-alerts/issues/138): utterance/pipeline mismatch or unanswered get_response, see PR discussion
...
class TestAdapt22_Deletelistentries(_IntentRoutingMixin, TestCase):
    ...
    @unittest.expectedFailure  # TODO(https://github.com/OpenVoiceOS/ovos-skill-alerts/issues/138): utterance/pipeline mismatch or unanswered get_response, see PR discussion
    @unittest.expectedFailure  # TODO(https://github.com/OpenVoiceOS/ovos-skill-alerts/issues/138): order-dependent shared-list state, see PR discussion
